# uPyLora
ESP32 using MicroPython meets lora. This repo includes the sx127x micropython driver to communicate between two devices using LoRa. The repository is extended for LoRaWAN in the following repository: https://github.com/lemariva/uPyLoRaWAN/tree/LoRaWAN
